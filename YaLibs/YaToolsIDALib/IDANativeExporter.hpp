...
struct IExporter
{
    ...
    virtual void make_name              (std::shared_ptr<YaToolObjectVersion>& object_version, ea_t ea, bool is_in_func) = 0;
    virtual void make_comments          (std::shared_ptr<YaToolObjectVersion>& object_version, ea_t ea) = 0;
    virtual void make_header_comments   (std::shared_ptr<YaToolObjectVersion>& object_version, ea_t ea) = 0;
    virtual void make_segment           (std::shared_ptr<YaToolObjectVersion>& object_version, ea_t ea) = 0;
    virtual void make_segment_chunk     (std::shared_ptr<YaToolObjectVersion>& object_version, ea_t ea) = 0;
};
